  ...
  <div style="background: white; padding: 40px; border-radius: 10px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); width: 100%; max-width: 400px;">
    ...
    <form action="/users/login" method="post">
      ...
      <div style="display: flex; justify-content: center; gap: 10px;">
        ...
        <a href="/users/register" style="background: #6c757d; color: white; padding: 12px 30px; border: none; border-radius: 5px; cursor: pointer; text-align: center; display: inline-block; flex: 1; box-sizing: border-box; text-decoration: none;">
          Cadastrar
        </a>
      </div>
    </form>
