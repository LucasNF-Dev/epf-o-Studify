    ...
    <div style="background: white; padding: 40px; border-radius: 10px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); width: 100%; max-width: 600px;">
        ...
        <form action="/schedule/add" method="post">
            ...
            <div style="display: flex; gap: 20px; margin-bottom: 20px;">
                <div>
                    <label for="start_time" style="display: block; margin-bottom: 5px; color: #555;">Início</label>
                ...
                <div>
                    <label for="end_time" style="display: block; margin-bottom: 5px; color: #555;">Fim</label>
