...
<h1 style="text-align: center; margin-bottom: 30px; color: #333;">Registrar</h1>
...
<form action="/users/register" method="post">
    ...
    <div style="margin-bottom: 20px;">
        <input type="date" id="birthdate" name="birthdate" required placeholder="Data de nascimento"
        style="width: 100%; padding: 12px; border: 1px solid #ddd; border-radius: 5px; font-size: 16px; box-sizing: border-box;"
        value="{{ birthdate or '' }}">
    </div>
    ...
    <div style="display: flex; justify-content: center; gap: 10px;">
        <button type="submit" style="background: #28a745; color: white; padding: 12px 30px; border: none; border-radius: 5px; cursor: pointer; flex: 1; box-sizing: border-box;">
            Registrar
        </button>
        <a href="/users/login" style="background: #6c757d; color: white; padding: 12px 30px; border: none; border-radius: 5px; cursor: pointer; text-align: center; display: inline-block; flex: 1; box-sizing: border-box; text-decoration: none;">
            Voltar
        </a>
    </div>
</form>
